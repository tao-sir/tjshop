...
<div class="pop">
		<form method="post" class="sets">
			...
			<a>
			<input type="button" class="agree" name="" id="refuse" value="拒绝" />
			</a>
...
$('.set').click(function(e){
    ...
    if(tel)
    {
    	$(".pop").find('form').attr('action',"/index.php/Admin/Index/audit/userid/"+userid+"/tel/"+tel);
        //$(".pop").find('form').attr('action',"<?php echo U('Index/audit',array('userid'=>"+userid+",tel=>"+tel+"));?>");
    	$(".sets").find('a').attr('href',"/index.php/Admin/Index/delete/id/"+userid+"/tel/"+tel);
    }else{ 
    	$(".pop").find('form').attr('action',"/index.php/Admin/Index/audit/userid/"+userid+"/compname/"+compname);
        //$(".pop").find('form').attr('action',"<?php echo U('Index/audit',array('userid'=>"+userid+",tel=>"+tel+"));?>");
    	$(".sets").find('a').attr('href',"/index.php/Admin/Index/delete/id/"+userid+"/compname/"+compname);
    }
