...
<head>
    ...
    <link rel="stylesheet" href="<?php echo C('CSS_URL');?>purchase.css" />
...
<body>
	<div class="header">
		...
		<a href=""><span class="color-b" style="margin-right: 10px;">预购</span></a><a href="purchase2.html"><span style="margin-left: 10px;color: #FFFFFF;">预售</span></a>
	</div>
