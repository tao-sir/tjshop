...
class UserController extends Controller {
    ...
    public function login(){
        if(IS_POST){
            ...
            $info = D('User')->where(array('usercode'=>$name,'password'=>$pwd1))->find();
            if($info !== null){
            //持久化用户信息
                ...
                if($result){
                    ...
                    if($checkcode != $code){
                        ...
                        */
                            ...
                            qrcode("http://tt.qiantianzc.com:8086/tjshop/index.php/Home/User/register/usercode/".$shuju['usercode'],3,10,"Uploads/Code/".$shuju['qrcode'].'.png');
                            if($user->add($shuju)){
