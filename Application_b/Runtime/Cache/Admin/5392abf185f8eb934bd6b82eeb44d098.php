...
<body>
	...
	<table border="0" cellspacing="0" cellpadding="10" id="table1">		
		<tr><td>电话：</td><td><input type="text" name="" class="tel" id="" value="" /></td><td>所属机构：</td><td><input type="tel" name="" id="" class="msg" value="" /></td><td>从：<input type="date" /></td><td>至：<input type="date" /></td><td class="color-l"><input type="submit" value="查询" class="search"/></td></tr>
	</table>
	</form>
	<table border="0" cellspacing="0px" cellpadding="10px" id="table2" >	
		...
		<tr><td>1</td><td>13503816234</td><td>日精</td><td>2000</td><td>河南科技</td>
			<td>500</td><td>2000</td><!--<td class="color-l set">审核</td>-->
		</tr>
